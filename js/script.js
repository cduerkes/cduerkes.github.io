$(document).ready(function() {
  ...
  $(".panel-nav a#problem-solving").click(function(){
    ...
    $.each(panels, function(index, value) {
      if ($(value).is(':visible')) {
        $(value).hide('slide',{direction:'left'}, 200)};
    }); 
  ...
  $(".panel-nav a#code-quality").click(function(){
    ...
    $('.code-quality-panel').show('slide',{direction:'left'}, 200);
  });
  $(".panel-nav a#collaboration").click(function(){
    ...
    $('.collaboration-panel').show('slide',{direction:'left'}, 200);
  });
  $(".panel-nav a#code-samples").click(function(){
    ...
    $('.code-samples-panel').show('slide',{direction:'left'}, 200);
  });
